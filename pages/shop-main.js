...
// ======================= Shop Main Beers =======================
const shopBeersSection = document.querySelector(
    ".shop-category.beers-section"
  );
...
const shopPivoladaSection = document.querySelector(
  ...
  // ======================= Shop Main Merch =======================
const shopMerchSection = document.querySelector(
    ".shop-category.merch-section"
  );
  ...
  const pivoladaShopCategory = document.querySelector(
    ".pivolada-category"
  );
